...
// import { creatfreightNFT, getMintedNFT } from "../util/nftport";
...
//       setData(res.data);
//       console.log("freight request", res.data);
//     } catch (e) {
//       console.error(e);
...
//       alert("Error completing freight: " + JSON.stringify(e));
//     } finally {
//       setLoading(false);
//     }
//   };
